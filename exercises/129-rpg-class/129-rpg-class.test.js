...
import { Character, Warrior, Mage, Archer } from './129-rpg-class.js';

test('Character class - basic initialization', () => {
...
test('Character class - default parameters', () => {
...
test('Character class - multiple instances are independent', () => {
...
test('Character class - is instance of Character', () => {
...
test('Warrior class - basic initialization', () => {
...
test('Warrior class - custom values', () => {
...
test('Warrior class - multiple instances', () => {
...
test('Warrior class - is instance of Warrior', () => {
  const warrior = new Warrior('Test');
  
  assert(warrior instanceof Warrior, 'Warrior should be instance of Warrior');
  assert.strictEqual(typeof warrior, 'object', 'Warrior should be object type');
});

test('Mage class - basic initialization', () => {
...
test('Mage class - multiple instances', () => {
...
test('Mage class - is instance of Mage', () => {
  const mage = new Mage('Test');
  
  assert(mage instanceof Mage, 'Mage should be instance of Mage');
  assert.strictEqual(typeof mage, 'object', 'Mage should be object type');
});

test('Archer class - basic initialization', () => {
...
test('Archer class - custom values', () => {
...
test('Archer class - multiple instances', () => {
...
test('Archer class - is instance of Archer', () => {
  const archer = new Archer('Test');
  
  assert(archer instanceof Archer, 'Archer should be instance of Archer');
  assert.strictEqual(typeof archer, 'object', 'Archer should be object type');
});
...
test('Class instances - modifications do not cross', () => {
...
test('Class - proper initialization of numeric properties', () => {
...
test('Class - proper initialization of boolean properties', () => {
...
test('Class syntax vs constructor functions - both work with new', () => {
  const character = new Character('Test');
  const warrior = new Warrior('Test');
  
  assert(character instanceof Character, 'Character class works with new');
  assert(warrior instanceof Warrior, 'Warrior class works with new');
  assert.strictEqual(typeof character, 'object', 'Class creates object');
  assert.strictEqual(typeof warrior, 'object', 'Class creates object');
});

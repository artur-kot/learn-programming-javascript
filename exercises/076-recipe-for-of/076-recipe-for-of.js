...
export function listAllRecipeIngredients(recipeId) {
  // TODO: Use for...of loop to iterate through ingredients
  // Build and return a single formatted string with all ingredients
  // Format: 'Ingredient 1, Ingredient 2, Ingredient 3...'
}

export function validateIngredients(recipeId) {
  // TODO: Use for...of to check each ingredient
  // Return object with { valid: boolean, missingFields: [...] }
  // Check that each ingredient has: name, amount, unit
}

export function calculateTotalAmountByUnit(recipeId) {
  // TODO: Use for...of to sum amounts grouped by unit
  // Return object like { 'cups': 5, 'teaspoons': 2, 'tablespoons': 3 }
}

export function findIngredientsByUnit(recipeId, targetUnit) {
  // TODO: Use for...of loop to find all ingredients with specific unit
  // Return array of matching ingredients
}

export function printRecipeInstructions(recipeId) {
  // TODO: Use for...of loop to create step-by-step instructions
  // Format each ingredient as a "Step N: Add X unit of ingredient"
